...
const ROWS = [
  ["WASD", "이동"],
  ["E / Space", "커피·먹이·자판기·분리수거·물주기·책장팁·낮잠·쓰다듬기"],
  ["F", "팔로우"],
  ["M", "뮤트"],
  ["L", "시간대(BGM 톤)"],
  ["미니맵 클릭", "카메라 pan"],
  ["Nap Pod", "숨결 글로우 (?nappod=0 끄기)"],
  ["수면 러그", "소프트 sheen (?sleeprug=0 끄기)"],
  ["Focus 듀얼데스크", "모니터 LED (?dualdesk=0 끄기)"],
  ["사장실 창", "시티라이트 (?ceowindow=0 끄기)"],
  ["분리수거함", "라운지 rustle (?recycle=0 끄기)"],
  ["청소로봇", "로비 복도 순찰 (?vacuum=0 끄기)"],
  ["? / /", "이 도움말"],
];
